...
object Day2 extends App {
  ...
  println(simpleNavigate(Source.fromFile("src/main/scala/day2input.txt").getLines.toSeq))
  println(aimedNavigate(Source.fromFile("src/main/scala/day2input.txt").getLines.toSeq))
}
